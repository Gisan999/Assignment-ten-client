...
const Product = ({ product, selected }) => {
    const { image, brandName, name, price, rating, shortDescription, _id } = product;
    ...
    if(selected.length < 1){
        Swal.fire({
            title: 'Oops!',
            text: 'We do not have any products related to this brand',
            icon: 'warning',
        ...
        <div>
            <div>
                <div  data-aos="fade-up" className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <img className="p-5 w-72 h-72 rounded-t-lg" src={image} alt="product image" />
                      </div>
